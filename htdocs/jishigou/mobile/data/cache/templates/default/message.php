...
</style> <?php } ?> <div id="g_isrcollWrapper"> <?php } ?> <div data-role="content" id="message_wp"> <script language="javascript"> <?php if($code == 404 || $code == 411) { ?>
...
<?php } ?> </script> </div> <?php if(!$this->Config['is_mobile_client']) { ?> </div> <?php } ?> </div><?php echo $GLOBALS['_J']['config']['tongji']; ?></body> </html>