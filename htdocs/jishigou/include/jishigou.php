...
class jishigou {
	...
	private function _init_config() {
		...
		$config['changeword']['n_weibo'] || $config['changeword']['n_weibo'] = 'Î¢²©';
		$config['changeword']['p_weibo'] || $config['changeword']['p_weibo'] = 'Î¢²©';
		$config['changeword']['weiqun'] || $config['changeword']['weiqun'] = 'Î¢Èº';
		$config['changeword']['dig'] || $config['changeword']['dig'] = 'ÔÞ';
		$config['changeword']['username'] || $config['changeword']['username'] = 'êÇ³Æ¡¢Email¡¢¸öÐÔÓòÃû';
		$config['changeword']['account'] || $config['changeword']['account'] = 'ÕÊºÅêÇ³Æ';
